...
gulp.task('jekyll-build', function (done) {
	return cp.spawn(jekyllCommand, gulp.series('exec', 'jekyll', 'build'), {stdio: 'inherit'}).on('close', done);
});
...
gulp.task('watch', function() {
	...
	gulp.watch(gulp.series('*html', '_includes/*html', '_layouts/*.html'), gulp.series('jekyll-rebuild'));
});
